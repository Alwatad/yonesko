...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "pages_blocks_hotspot_zone" ADD CONSTRAINT "pages_blocks_hotspot_zone_subcategory_id_product_categories_id_fk" FOREIGN KEY ("subcategory_id") REFERENCES "public"."product_categories"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_hotspot_zone" ADD CONSTRAINT "_pages_v_blocks_hotspot_zone_subcategory_id_product_categories_id_fk" FOREIGN KEY ("subcategory_id") REFERENCES "public"."product_categories"("id") ON DELETE set null ON UPDATE no action;
