...
export const enum_paywalls_paywall = pgEnum("enum_paywalls_paywall", ["cash", "stripe", "autopay", "p24"]);
...
export const posts_rels = pgTable(
  "posts_rels",
  {
    ...
    postsID: uuid("posts_id"),
    categoriesID: uuid("categories_id"),
    administratorsID: uuid("administrators_id"),
  },
  (columns) => ({
...
export const orders = pgTable(
  ...
  {
    id: varchar("id").primaryKey(),
    customer: uuid("customer_id").references(() => customers.id, {
      onDelete: "set null",
    }),
...
export const email_messages = pgTable(
  "email_messages",
  {
    ...
    messages_logo: uuid("messages_logo_id").references(() => media.id, {
      onDelete: "set null",
    }),
...
export const paywalls = pgTable("paywalls", {
  id: uuid("id").defaultRandom().primaryKey(),
  paywall: enum_paywalls_paywall("paywall").notNull().default("cash"),
